<div class="modal fade" id="anual" role="dialog">
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			...
			<div class="modal-header">
				...
				<h4 class="modal-title" id="myModalLabel">Pago Anual</h4>
			</div>
...
<input type="hidden" name="amount" value="{{ $monto }}" id="amount">
				...
				<table class='table table-condensed table_cont'>
					<thead>
				        ...
				        <tr>
				        	<td>Descuento pago anual</td>
				        	<td>{{'-$'. number_format($monto, 2) }}</td>
				        </tr>
				        <tr>
				        	<td>Total a pagar</td>
							<td>{{'$ '. number_format(($total - $monto), 2) }}</td>
						</tr>
				</table>
			...
			<div class="modal-footer">
				{!!link_to('#', $title='Proceder a Pagar', $attributes = ['id'=>'anual_pago', 'class'=>'btn btn-primary'], $secure=null)!!}
			</div>
		</div>
	</div>
</div>

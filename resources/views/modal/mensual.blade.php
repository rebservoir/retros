<div class="modal fade" id="mensual" role="dialog">
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			...
			<div class="modal-header">
				...
				<h4 class="modal-title" id="myModalLabel">Pago Mensual</h4>
			</div>
...
<input type="hidden" name="amount" value="{{ $monto }}" id="amount">
			...
			<div class="modal-footer">
				{!!link_to('#', $title='Proceder a Pagar', $attributes = ['id'=>'mensual_pago', 'class'=>'btn btn-primary'], $secure=null)!!}
			</div>
		</div>
	</div>
</div>
